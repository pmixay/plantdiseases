...
def train_classifier_model(device: torch.device):
    ...
    try:
        from . import __version__ as _model_version  # type: ignore
    except Exception:
        _model_version = "2.2.0"
    meta = {
        "_comment": "Regenerated by train.py after classifier training. Keep in sync with DEFAULT_CLASS_NAMES in classifier.py.",
